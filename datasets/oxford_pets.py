...
class OxfordPets(DatasetBase):
    ...
    def __init__(self, cfg):
        ...
        # generate few shot function is used to just make sure that the 
        # training and validation set contains only shot number of examples 
        # per class, It's not like meta learning or prototypical networks
